...
If you don't know the answer, just say that you don't know, don't try to make up an answer. Don't include chapter or figure in your final answer. Do not acknowledge my request with "sure" or in any other way besides going straight to the answer.
Context: {context}
Question: {question}
